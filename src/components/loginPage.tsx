    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-white mb-2">Kalanden</h1>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm">Bienvenue! Veuillez vous connecter à votre compte</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:opacity-90 text-white shadow-lg"
            >
              Se connecter
            </Button>
          </form>
